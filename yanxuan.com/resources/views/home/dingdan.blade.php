...
@section('contents')
	...
	<style>
	   ...
	   <div class="g-row"> 
	    <div style="position: absolute; right: 0px; top: -36px; display: block;" class="m-noticeList noticeList j-topNoticeList limitLength"> 
	     <ul class="j-list list"> 
	      <li class="j-notice notice"> <a target="_blank" href="http://you.163.com/ notice/detail?id=1010000&amp;_stat_content=1周年庆：严选开启支持港澳台配送测试" class="txt f-text-underline"> 1周年庆：严选开启支持港澳台配送测试 </a> </li> 
	     </ul> 
	    </div> 
	    <div class="g-panel"> 
	     <div class="w-panel"> 
	      ...
	      <div class="bd" id="info"> 
	       <div class="m-orderAddress" id="j-orderAddress">
	        <div>

		

	         <form novalidate="" action="" method="post" class="m-form-addr m-form-addr-1 j-form"> 
	          ...
	          <div class="lmodule"> 
	           ...
	           <!-- 全国地区三级联动开始 -->
	            ...
	            <div class="w-col-4"> 
	             ...
	             <div class="w-error-warp j-error-wrap mgr"> 
	              <select tabindex="4" class="w-select j-city" id="s_city" name="s_city"><option value="">请选择</option></select> 
	              <div style="clear:both"></div> 
	              <div class="w-errorMsg j-error" style="display: none;"> 
	               <i class="icon w-icon-normal icon-normal-disable"> </i>
	             ...
	             <div class="w-error-warp j-error-wrap"> 
	              <select tabindex="5" class="w-select j-district" id="s_county" name="s_county"><option value="">请选择</option></select> 
	              <div style="clear:both"></div> 
	             <div class="w-errorMsg j-error" style="display: none;"> 
	               <i class="icon w-icon-normal icon-normal-disable"> </i>
	               <span class="text j-errorTip">县不能为空</span>
	              </div>
	             </div> 
	             
	             
	             
		              <input type="hidden" value="" class="j-provincename" name="provinceName" /> 
		             <input type="hidden" value="" class="j-cityname" name="cityName" /> 
		             <input type="hidden" value="" class="j-districtname" name="districtName" /> 
					  <div id="show"></div>
	            </div>
	           ...
	           <div class="w-row-addr"> 
	            <div class="w-col-4"> 
	             <span style="vertical-align: top;margin-top:6px;" class="w-label">详细地址：</span> 
	             <div class="w-textarea w-error-warp j-error-wrap"> 
	              <textarea tabindex="6" rows="10" cols="30" id="address" name="address" class="opp" placeholder="街道、门牌号等"></textarea> 
	              <div class="w-errorMsg j-error" style="display: none;"> 
	               <i class="icon w-icon-normal icon-normal-disable"> </i>
	           ...
	           <div class="w-row-addr w-row-addr-1" style="margin-top:30px"> 
	            <div class="w-col-2"> 
	             <span class="w-label">收货人：</span> 
	             <div class="w-error-warp j-error-wrap"> 
	              <input type="text" tabindex="1" id="shouhuo" value="" name="name" class="w-ipt" />
	              <div class="w-errorMsg j-error" style="display: none;"> 
	               <i class="icon w-icon-normal icon-normal-disable"> </i>
	            ...
	            <div class="w-col-5 zoneTipsInner"> 
	             <span class="w-label">手机号码：</span>
	             <div class="w-error-warp j-error-wrap"> 
	              <input type="text" tabindex="2" id="shouji" required="required" value="" name="mobile" class="w-ipt j-mobileFilter" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" /> 
	              <div class="w-errorMsg j-error" style="display: none;"> 
	               <i class="icon w-icon-normal icon-normal-disable"> </i>
	               <span class="text j-errorTip">手机号不能为空</span>
	              </div>
	              <span class="w-zoneTips j-zoneTips"></span> 
	             </div> 
	            </div>
	            <div style="clear:both"></div> 
	          ...
	          <div class="rmodule"> 
	           <div class="w-row-addr w-row-addr-1"> 
	            <div class="w-col-1"> 
	             <div class="w-chkbox"> 
	              <input type="checkbox" class="j-checkbox" name="dft" checked="checked" />
	            ...
	            <div class="w-col-1 mgr24"> 
	             <button class="w-button w-button-primary w-button-l j-submit" type="">确定</button>
	             <a class="j-cancel w-button w-button-l w-button-ghost" style="display: none;">取消</a> 
	             <div style="display: none;left:0px;top:47px;" class="w-errorMsg j-msg">
	              <i class="icon w-icon-normal icon-normal-disable"></i>
		 ...
		 @else
			  <div class="bd" > 
			   <div id="j-orderAddress" class="m-orderAddress">
			    <div id="j-shipAddress" class="left m-address" data-ship-address-id="5818608">
			     <p class="line line-1"><i class="w-icon-normal icon-normal-address-default"></i></p>
			     <p class="line"><label class="label"><span class="textLeft">收</span><span>货</span><span class="textRight">人&nbsp;:&nbsp;</span></label><span class="text shouhuo">{{$moren->a_name}}</span></p>
			     <p class="line"><label class="label">联系方式&nbsp;:&nbsp;</label><span class="text lianxi">{{substr_replace($moren->a_phone,'****',3,4)}}</span></p>
			     <p class="line"><label class="label">收货地址&nbsp;:&nbsp;</label><span class="text shouhuodizhi">{{$moren->a_address}}</span></p>
			    </div>
			    <div class="right">
			     <p id="j-changeOrderAddress" class="changeAddress"><a class="w-link" id="dizhi" href="javascript:;">切换地址</a></p>
		...
		@endif
			...
			<!-- ============================================================================ -->
			<div class="bd" id="into" style="display:none"> 
			 <div id="j-orderAddress" class="m-orderAddress">
			  <div id="j-shipAddress" class="left m-address" data-ship-address-id="5818608">
			   <p class="line line-1"><i class="w-icon-normal icon-normal-address-default"></i></p>
			   <p class="line"><label class="label"><span class="textLeft">收</span><span>货</span><span class="textRight">人&nbsp;:&nbsp;</span></label><span class="text shouhuo2">jiang</span></p>
			   <p class="line"><label class="label">联系方式&nbsp;:&nbsp;</label><span class="text lianxi2"></span></p>
			   <p class="line"><label class="label">收货地址&nbsp;:&nbsp;</label><span class="text shouhuodizhi2"></span></p>
			  </div>
			  <div class="right">
			   <p id="j-changeOrderAddress" class="changeAddress"><a class="w-link" id="dizhi" href="javascript:;">切换地址</a></p>
		      ...
		      <div class="bd" style="display:none"> 
		       <div class="m-orderAddress" id="j-orderAddress">
		        <div>
		         ...
		         <form novalidate="" action="/home/dizhi" method="post" class="m-form-addr m-form-addr-1 j-form"> 
		          <input type="hidden" value="0" name="id" /> 
		          <div class="lmodule"> 
		           <div class="w-row-addr addrFirst"> 
		           ...
		           <div class="w-row-addr"> 
		            <div class="w-col-4"> 
		             <span style="vertical-align: top;margin-top:6px;" class="w-label">详细地址：</span> 
		             <div class="w-textarea w-error-warp j-error-wrap"> 
		              <textarea tabindex="6" rows="10" cols="30" id="address" name="address" placeholder="街道、门牌号等"></textarea> 
		              <div class="w-errorMsg j-error" style="display: none;"> 
		               <i class="icon w-icon-normal icon-normal-disable"> </i>
		               <span class="text j-errorTip">详细地址不能为空</span>
		              </div>
	    ...
	    <div class="g-itemInfo"> 
	     <div class="m-giftCardTips j-giftCardTips">
	       电子礼品卡后支付成功并发货后，可在订单详情页提取卡号和密码 
	     </div> 
	     <div class="m-table"> 
	      ...
	      <table class="m-orderTable"> 
	       ...
	       <tbody id="j-items" class="tbody">

	       <!-- 商品遍历从此开始 -->
	        <tr class="tr">
	         <td class="td col1"><img style="margin-top:-30px" src="{{explode(',',$goods->g_pic)[0]}}" class="img" /></td>
	         <td class="td col2">
	          <div class="pd-info" style="margin-bottom:40px;position:relative;top:60px">
	           <div class="line line-2">
	            <div class="product-name">
	             {{$goods->g_name}}
	            </div>
	           </div>
	           <p class="line line-1"><span>{{$class->gd_color}} {{$class->gd_size}} {{$class->gd_nature}}</span></p>
	          </div>
	          </td>
				@if($ltime=='')
				<td class="td col3"><p>&yen;{{$goods->g_price}}.00</p></td>
				<td class="td col4">{{$num}}</td>
				<td class="td col5">&yen;{{($goods->g_price) * $num}}.00</td>
				<td class="td col6 ">&yen;<span class="shen">{{($goods->g_price) * $num }}.00</span></td>
	          @elseif($ltime->l_ctime<time()&&$ltime->l_ltime>time())
	          <td class="td col3"><p>&yen;{{$goods->g_coupon}}.00</p>
				<p style="text-decoration:line-through;color:#999">¥{{$goods->g_price}}.00</p>
				<span class="u-promotion-tag">限时购</span>
	          </td>
	          <td class="td col4">{{$num}}</td>
	          <td class="td col5">&yen;{{($goods->g_coupon) * $num}}.00</td>
	          <td class="td col6 ">&yen;<span class="shen">{{($goods->g_coupon) * $num }}.00</span></td>
	          @else
	         <td class="td col3"><p>&yen;{{$goods->g_price}}.00</p></td>
	         <td class="td col4">{{$num}}</td>
	         <td class="td col5">&yen;{{($goods->g_price) * $num}}.00</td>
		...
		<!-- 商品遍历在此结束 -->
	     ...
	     <div class="m-invoice"> 
	      <div class="tt">
	       发票信息
	       <a target="_blank" href="/help#invoiceQues" class="w-link"><i class="w-icon-normal icon-normal-ask"></i></a>
	      </div> 
	      <div class="g-invoice"> 
	       <div class="w-chkbox">
	        <input type="checkbox" checked="" disabled="disable" class="j-checkboxInvoice" />
	        <span class="">我要发票</span>
	       </div> 
	       <div class="invoice-info j-invoice-info"></div> 
	      </div> 
	     </div> 
	     <div id="j-itemInfoFt" class="m-itemInfoFt">
	      <div class="left">
	       <div class="tt">
	        使用优惠券
	        
	        <a href="/help#rule"><i class="w-icon-normal icon-normal-ask"></i></a>
	       </div>
	       <div class="hd">
	        <a class="w-button btn j-changeCoupon" href="javascript:;">选择优惠券</a>
	       </div>
	       <div class="ft">
	        
	        <form class="m-activateCouponIpt j-activateCouponIpt f-dn">
	         <div class="hd">
	          <input type="text" placeholder="请输入优惠码" class="ipt" id="j-activateCouponIpt" />
	          <input type="submit" value="兑换" class="btn" id="j-activateCouponBtn" />
	         </div>
	         <div class="ft">
	          <div style="display: none;" class="w-tipMsg w-tipMsg-success msg" id="j-activateCouponTip">
	           <i class="icon"></i>
	       ...
	       <div class="hd">
	        <div class="w-chkbox">
	         ...
	         <span style="font-size: 14px;line-height: 18px;" class="f-txt-red f-hide j-invoiceGiftCard"><i class="w-icon-normal icon-normal-alert">&nbsp;&nbsp;</i> 开发票金额将会排除礼品卡支付金额</span>
	        </div>
	        <div style="display:none;" class="w-payPwd j-payPwdIptWrap">
	         <form class="payPassWordForm" >
	          <input type="text" style="display:none" name="name" />
	          <input type="password" style="display:none;" name="paypwd" />
	          <input type="password" maxlength="6/" class="ipt" placeholder="请输入支付密码" name="paypwd" id="j-payPwdIpt" />
	          <a class="w-link link" target="_blank" href="/user/securityCenter/resetPayPwd">忘记密码?</a>
	          <div style="display: none;" class="w-tipMsg w-tipMsg-success msg" id="j-payPwdTip">
	           <i class="icon"></i>
	           <span class="text"></span>
	          </div>
	         </form>
	       ...
	       <div class="ft">
	        ...
	        <form class="m-giftCardIpt j-showGiftCardIpt f-dn">
	         <div class="hd">
	          <input type="text" placeholder="请输入礼品卡密码" class="ipt" id="j-giftCardIpt" />
	          <input type="submit" value="绑定" class="btn" id="j-giftCardBtn" />
	         </div>
	         <div class="ft">
	          <div style="display: none;" class="w-tipMsg w-tipMsg-success msg" id="j-giftCardTip">
	           <i class="icon"></i>
	           <span class="text"></span>
	          </div>
	         </div>
...
<!-- ======================================================================================================= -->
<!-- ======================================================================================================= -->
	    <form action="/home/dingdans" method="post" target="_self">
	      <div class="right">
	       <p class="line1"><label>商品合计<span>:</span></label><span class="amount">&yen;<span class="heji">00.00</span></span></p>
	       <div class="line3">
	        <div class="right">
	         <label>运费<span>:</span></label>
	         <span class="amount">&yen;<span class="yun">0.00</span></span>
	        </div>
	       ...
	       <div class="line3">
	        <div class="right">
	         <label>优惠券<span>:</span></label>
	         <span class="amount">&yen;<span class="youhui">0.00</span></span>
	        </div>
	       </div>

	       <p class="line4"><label class="label">应付总额<span>:</span></label><span class="price">&yen;<span class="shifu">00.00</span></span></p>
	       <div class="line5">
	       @if(empty($pdd))
	        <input type="submit" disabled="disabled"  value="去付款" class="w-button w-button-primary w-button-xl submit" id="j-orderConfirmSubmit" />
	        @else
	        <input type="submit"  value="去付款" class="w-button w-button-primary w-button-xl submit" id="j-orderConfirmSubmit" />
	       @endif
	        <input type="hidden" name="_token" value="{{ csrf_token() }}">


	        <input type="hidden" name="g_id" value="{{$goods->g_id}}" id="PPP1">
	        <input type="hidden" name="gd_id" value="{{$class->gd_id}}" id="PPP2">
	        <input type="hidden" name="c_id" value="" id="PPP3">
	        <input type="hidden" name="heji" value="" id="PPP4">
	        <input type="hidden" name="o_zong" value="" id="PPP5">
	        <input type="hidden" name="o_num" value="{{$num}}" id="PPP6">


	        <div class="notice">
	         <a target="_blank" href="/help#notice" class="f-hide">春节期间发货公告</a>
	        </div>
	       </div>
	       <div style="display: none;" class="w-tipMsg w-tipMsg-success msg" id="j-addressTip">
	        <i class="icon"></i>
	        <span class="text"></span>
	       </div>
	       <div id="j-userinfo-ft" class="line6"></div>
	      </div>
	   </form>
<!-- ============================================================================================================ -->
<!-- ============================================================================================================ -->
<!-- ============================================================================================================ -->
	     ...
	     <div class="m-agreement"> 
	      <a href="" class="w-link agreement">同意《严选平台服务协议》</a> 
	      <div class="w-chkbox checkbox"> 
	       <input type="checkbox" checked="" disabled="true" id="j-agreeCheckbox" /> 
	      </div> 
	     </div> 
	   ...
	   <!-- 模态框在此开始 -->
	     ...
	     <div id="widgetDialogContainer" style="display:none;">
	      <div class="m-overlay m-overlay-ani" style="z-index: 1190; position: absolute;"> 
	       <div class="w-mask w-mask-ani j-mask f-ani-mask"></div> 
	       <div class="m-pop f-scroll-y overlay-container-ani f-tlbr j-overlay-container m-couponPop f-ani-bouncein" style="top: auto; display: block;"> 
	        <div class="j-w-dialog-body" style="left: 414.5px; top: 492.5px;"> 
	         <div class="j-w-dialog-head"> 
	          <div class="w-close j-close-pop"></div> 
	         </div> 
	         <div class="popwin-bd j-w-dialog-content"> 
	          <div class="m-coupons" id="j-coupons"> 
	           <h3 class="title">选择优惠券</h3> 
	           <div class="bd"> 
	            <ul class="m-couponList"> 
	            </ul> 
	            <div class="nouseable-title"> 
	             <div class="line"></div> 
	             <p class="no-useable-tip">以下不适用于此订单</p> 
	            </div> 
	            <ul class="m-couponList"> 
	            ...
	            @if($v->c_status == 1)
	             <li class="item"> 
	             @if(time()-$v->c_overTime > 0)
	              <div data-id="69307292" class="j-coupon w-coupon coupon-l coupon-disabled"> 
				 @else
				 <div data-id="69307292" class="j-coupon w-coupon coupon-l coupon-func">
				 @endif 
	               <div class="active-bg"> 
	               ...
	               <div class="inner"> 
	                ...
	                <div class="range"> 
	                 <span class="text"> 商品总金额满<span class="man" cid="{{$v->c_id}}">{{$v->c_claim}}</span>元  减<span class="jian">{{$v->c_money}}</span>元</span> 
	                ...
	                <div class="validity"> 
	                 <span class="f-fl"> 有效期&nbsp;:&nbsp;{{date('Y-m-d',$v->c_beginTime)}}-{{date('Y-m-d',$v->c_overTime)}} </span> 
	                </div> 
	                <div></div> 
	               </div>
	              </div></li> 
	           ...
	           <footer class="ft"> 
	            <button class="w-button w-button-l button-OK w-button-disabled" type="button" id="j-couponDialogOK">确定</button> 
	            <button class="w-button w-button-l" type="button" id="j-couponDialogCancel">取消</button> 
	           </footer> 
	          </div> 
	         </div> 
	        </div> 
	     ...
	     <!-- 切换地址的模态框在此 -->
	      ...
	      <div class="m-overlay m-overlay-ani qiehuan" style="z-index: 1350;display:none"> 
	        <div class="w-mask w-mask-ani j-mask f-ani-mask"></div> 
	        <div class="m-pop f-scroll-y overlay-container-ani f-tlbr j-overlay-container m-pop-changeAddr f-ani-bouncein" style="top: 0%; display: block;"> 
	         <div class="j-w-dialog-body" style="left: 513px; top: 206px;"> 
	          <div class="j-w-dialog-head"> 
	           <div class="w-close j-close-pop"></div> 
	          </div> 
	          <div class="popwin-bd j-w-dialog-content"> 
	           <div class="w-tit-addr">
	            选择地址
	           </div> 
	           <div class="w-body-addr" style="overflow-y:scroll">
	           @foreach($pdd as $k=>$v) 
	            <div class="w-addr-warp j-addr" data-id="5443270" sid="{{$v->a_id}}"> 
	             <div class="m-address"> 
	              <p class="line"> <label class="label"><span class="textLeft">收</span><span>货</span><span class="textRight">人&nbsp;:&nbsp;</span></label> <span class="text">{{$v->a_name}}</span> </p> 
	              <p class="line"> <label class="label">联系方式&nbsp;:&nbsp;</label> <span class="text">{{(substr_replace($v->a_phone,'****',3,4))}}</span> </p> 
	              <p class="line"> <label class="label">收货地址&nbsp;:&nbsp;</label> <span class="text">{{$v->a_address}}</span> </p> 
	              @if($v->a_mo == 1)
	           ...
	           <div style="margin:31px 0 0 80px"> 
	            <button type="" class="w-button w-button-primary w-button-l  j-ok" style="margin-left:45px">确定</button> 
...
@section('js')
	...
	$(function(){
		...
		$('.j-changeCoupon').click(function(){
			// alert(22);
			$(document).scrollTop(0);
			$('#widgetDialogContainer').show(50);
			$('#j-couponDialogOK').attr('disabled',true);
		})

		$('.j-close-pop').click(function(){
			$('#widgetDialogContainer').hide();
		})

		$('.w-button-l').click(function(){
			$('#widgetDialogContainer').hide();
		})


		//商品价格计算
		// console.log($('.shen').html());
		var cao = $('.shen');
		sss = 0;
		cao.each(function(){
			sss += parseInt($(this).html());
		})
		...
		//优惠券选中事件
		$('.coupon-func').click(function(){
			// alert(22);
			$('.coupon-func').css('border','');
			$('.coupon-func').removeAttr('id');
			$(this).css('border','3px solid gray');
			$(this).attr('id','hao');
			$('.button-OK').removeClass('w-button-disabled');
			$('.button-OK').addClass('w-button-primary');
			$('#j-couponDialogOK').attr('disabled',false);
		})

		

		shifu = sss+parseInt($('.yun').html())-parseInt($('.youhui').html())+'.00';
		$('.shifu').html(shifu);


		//点击添加地址按钮  判断所有信息是否全部填写
		$('.j-submit').click(function(){
			// alert(22);
			var h = 1
			// console.log($('#s_province').val());
			if($('#s_province').val() == '省份'){
				$('#s_province').next().next().show();
				$('#s_province').next().next().fadeOut(2500);
				h = 0;
			}
			if($('#s_city').val() == '地级市'){
				$('#s_city').next().next().show();
				$('#s_city').next().next().fadeOut(2500);
				h = 0;
			}
			if($('#s_county').val() == '市、县级市'){
				$('#s_county').next().next().show();
				$('#s_county').next().next().fadeOut(2500);
				h = 0;
			}
			// console.log($('#s_county').val());
			if($('#address').val() == ''){
				$('#address').next().show();
				$('#address').next().fadeOut(2500);
				h = 0;
			}
			if($('#shouhuo').val() == ''){
				$('#shouhuo').next().show();
				$('#shouhuo').next().fadeOut(2500);
				h = 0;
			}
			if($('#shouji').val() == ''){
				$('#shouji').next().show();
				$('#shouji').next().fadeOut(2500);
				h = 0;
			}
			...
			return false;
				...
				$('.shouhuo2').html(name);
				$('.lianxi2').html(mobile);
				$('.shouhuodizhi2').html(address);

				// console.log(u_id);
				$.post('/home/dizhi',{name:name,address:address,mobile:mobile,u_id:u_id},function(data){
					if(data){
					$('#j-orderConfirmSubmit').removeAttr('disabled');
		...
		$('.j-addr').click(function(){
			// alert(22);
			$('.j-addr').removeClass('active');
			$('.j-addr').removeAttr('id');
			$(this).addClass('active');
			$(this).attr('id','tru');
			$('.j-ok').attr('disabled',false);
		})

		//地址选择框的点击确定
		$('.j-ok').click(function(){
			// alert(22);
			// console.log($('#tru').attr('sid'));
			$.ajaxSetup({
			    headers: {
			        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
			    }
			...
			sid = $('#tru').attr('sid')
			$.post('/home/dingdan',{id:sid},function(data){
				if(data){
					shouhuo = $('#tru').children('.m-address').children('p:eq(0)').children('span');
					lianxi = $('#tru').children('.m-address').children('p:eq(1)').children('span');
					shouhuodizhi = $('#tru').children('.m-address').children('p:eq(2)').children('span');
					// console.log(shouhuo.html());
					$('.shouhuo').html(shouhuo.html());
					$('.lianxi').html(lianxi.html());
					$('.shouhuodizhi').html(shouhuodizhi.html());
					$('.qiehuan').fadeOut(300);
					$('#j-orderConfirmSubmit').removeAttr('disabled');
				}else{
					alert('修改失败');
		...
		$('#PPP5').val(parseInt(shifu));
		heji = parseInt($('.heji').html());
		$('#PPP4').val(heji);


		//优惠券确定事件
		$('#j-couponDialogOK').click(function(){
			// alert(22);
			// console.log($('#hao').children('.inner').children('.range').children('.text').children('.man').html());
			youman = $('#hao').children('.inner').children('.range').children('.text').children('.man').html();
			// console.log(youman);
			cid = $('#hao').children('.inner').children('.range').children('.text').children('.man').attr('cid');
			youjian = $('#hao').children('.inner').children('.range').children('.text').children('.jian').html()
			// console.log(cid);
			//判断是否符合优惠券使用条件
			if(sss > parseInt(youman)){
				$('#PPP3').val(cid);
				$('.youhui').html(parseInt(youjian)+'.00');
				shifu = sss+parseInt($('.yun').html())-parseInt($('.youhui').html())+'.00';
				$('#PPP4').val(shifu);
				$('.shifu').html(shifu);
				$('#PPP5').val(parseInt(shifu));
		...
		// $('#j-orderConfirmSubmit').click(function(){
