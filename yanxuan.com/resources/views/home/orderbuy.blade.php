	     ...
	     <div class="m-table"> 
	      ...
	      <table class="m-orderTable"> 
	       ...
	       <tbody id="j-items" class="tbody">
			...
			@foreach($goodss[$a] as $k=>$v)

	        <tr class="tr">
	         <td class="td col1"><img style="margin-top:-30px" src="{{explode(',',$v->g_pic)[0]}}" class="img" /></td>
	         <td class="td col2">
	          <div class="pd-info" style="margin-bottom:40px;position:relative;top:60px">
	           ...
	           <p class="line line-1"><span>{{$v->gd_nature}} {{$v->gd_color}} {{$v->gd_size}}</span></p>
	          </div>
	          </td>
                @if($v->g_coupon > 0)
                <td class="td col3"><p>&yen;{{$v->g_coupon}}</p>
      			<p style="text-decoration:line-through;color:#999">¥{{$v->g_price}}.00</p>
      			<span class="u-promotion-tag">限时购</span>
                </td>
                <td class="td col4">{{$b->od_num}}</td>
                <td class="td col5">&yen;{{($v->g_coupon) * $b->od_num}}.00</td>
                <td class="td col6 ">&yen;<span class="shen">{{($v->g_coupon) * $b->od_num}}.00</span></td>
                 @else
	         	<td class="td col3"><p>&yen;{{$v->g_price}}.00</p></td>
	        	<td class="td col4">{{$b->od_num}}</td>
	         	<td class="td col5">&yen;{{($v->g_price) * $b->od_num}}.00</td>
	         	<td class="td col6 ">&yen;<span class="shen">{{($v->g_price) * $b->od_num}}.00</span></td>
	         	@endif
	        </tr>
			@endforeach
			@endforeach
	     ...
	     <div id="j-itemInfoFt" class="m-itemInfoFt">
	      ...
	      <div class="right">
	       ...
	       <div class="line3">
			...
			<!-- ========================================================= -->
	<form action="/home/qufukuan" method="post" >
	       ...
	       <div class="line5">
	        ...
	        <input type="hidden" name="o_id" value="{{$o_id}}" id="pos1">
