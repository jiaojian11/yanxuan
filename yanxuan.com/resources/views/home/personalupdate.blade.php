	   ...
	   <div class="g-row"> 
	    ...
	    <div class="g-main"> 
	     <div id="j-userinfoForm">
	      ...
	      <form class="m-userInfoForm" action="/home/userinfo" method="post" enctype="multipart/form-data">
	       ...
	       <div class="item">
	        ...
	        <div class="content f-left">
	         <input type="text" maxlength="20" value="{{$data->u_nickname}}" name="u_nickname" class="w-ipt w-ipt-l" />
	        </div>
	        ...
	        <div class="content f-left">
	         <div class="w-radio f-left s-gold">
	          <input type="radio" value="1" id="male" name="u_sex" class="raido" checked/>
	          <label class="ml3" for="male">男</label>
	         </div>
	         <div class="w-radio f-left ml40 s-gold">
	          <input type="radio" value="0" id="female" name="u_sex" class="radio" />
	       ...
	       <div class="item">
	        <label class="label f-left">上传头像</label>
	        <div class="content f-left">
	         <span class="j-bindMobileShow mr20 f-hide">null</span>
	          <input name="u_pic" type="file"/> 
	        </div>
	       </div>
	       <div class="item">
