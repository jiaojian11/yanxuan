...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/comment/comment"><i class="fa fa-circle-o"></i>评论</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"> 
                                    <div class="row"><div class="col-sm-12">
                                      <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                                              <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:60px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">商品id</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:140px;" aria-label="Browser: activate to sort column ascending">商品图片</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 140px;" aria-label="Platform(s): activate to sort column ascending">商品名</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 150px;" aria-label="Engine version: activate to sort column ascending">商品简介</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="CSS grade: activate to sort column ascending">用户评论数</th></tr>
                                              </tr>
                                              <tr>
                                                <td>{{$data->g_id}}</td>
                                                <td><img src="{{explode(',',$data->g_pic)[0]}}" width="50px" height="50px;"></td>
                                                <td>{{$data->g_name}}</td>
                                                <td>{{$data->g_intro}}</td>
                                                <td>{{$count[0]->aaa}}</td>
                                              </tr>
                                ...
                                <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                                    <thead>
                                        <tr role="row">
                                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:80px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">用户头像</th>
                                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:140px;" aria-label="Browser: activate to sort column ascending">用户名</th>
                                          <!-- <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 140px;" aria-label="Platform(s): activate to sort column ascending">商品名</th> -->
                                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 400px;" aria-label="CSS grade: activate to sort column ascending">用户评论</th>
                                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 80px;" aria-label="Engine version: activate to sort column ascending">购买规格</th>
                                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 108px;" aria-label="CSS grade: activate to sort column ascending">评价时间</th>

                                    </thead>
                                    <tbody>
                                    @foreach($res as $k=>$v)
                                      <tr>
                                          <td><img src="/homeCSS{{$v->u_pic}}" width="50px" height="50px"></td>
                                          <td>{{$v->u_account}}</td>
                                          <td>{{$v->co_comment}}</td>
                                          @if($vie[$k]->g_nature==1)
                                          <td><span style="text-overflow: ellipsis">规格:{{$vie[$k]->gd_nature}}</span></td>
                                          @else
                                          <td style="text-overflow: ellipsis">颜色:{{$vie[$k]->gd_color}}|尺寸:{{$vie[$k]->gd->size}}</td>
                                          @endif
                                          <td>{{$v->co_time}}</td>
                                      </tr>
                                     @endforeach
                                    </tbody>
                                </table></div></div><div class="row"><div class="col-sm-6"> {!! $res->appends(['id'=>$data->g_id])->render() !!}</div>
                                <div class="col-sm-6">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>后台管理版本</b> 6.54.1112
    </div>
    <strong>版权所有 &copy; 1998-2017 <a href="http://almsaeedstudio.com">工商编号</a>.</strong>20170401095356
  </footer>
