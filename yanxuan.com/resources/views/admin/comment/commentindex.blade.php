          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
               <form action="/admin/comment/comment" method="get">
                <tr>
                  <th>一级分类: &nbsp;<select class="first" name="first" id="">
                  <!-- <option value="" selected>无</option> -->
                    @foreach($data as $k=>$v)
                      <option value="{{$v->gc_id}}" selected>{{$v->gc_title}}</option>
                      @endforeach
                    </select></th>
                    <!-- {{ csrf_field() }} -->
                  <th>二级分类</th>
                  <td><select  class="two" name="two" id="">
                    </select></td>
                  <th><input type="text" name="sea"></th>
                ...
                @foreach($res as $k=>$v)
                <tr>
                  <td><img src="{{explode(',',$v->g_pic)[0]}}" width="50px" height="50px"></td>
                  <td>{{$v->g_name}}</td>
                  <td>{{$v->g_price}}</td>
                  <td>{{$v->g_intro}}</td>
                  <td>
                    <a href="/admin/comment?id={{$v->g_id}}">查看详情</a>
                  </td>
                </tr>
                @endforeach
                {!! $res->appends($abc)->render() !!}
              </table>
            </div>
            <!-- /.box-body -->
          </div>
...
<script type="text/javascript">
  ...
  $(function(){
    $('.first').change(function(){
        ...
        $.post('/admin/comment/change',{id:inp},function(data)
        {
    ...
    //             }
    //     });
    //     $.post('/admin/comment/goods',{id:inp},function(data)
    //     {
    //         three = eval(data);
    //         console.log(three);
    //         str1 = '';
    //         if(!three){
    //           str1 ='<tr class="act"><td colspan="5" align="center">无</td></tr>';
    //         }
    //         // console.log(two);
    //         $.each(three,function(k,v){
    //           str1+='<tr class="act"><td><img src="'+v.g_pic.split(",")[0]+'" width="50px" height="50px"/></td><td>'+v.g_name+'</td><td>'+v.g_price+'</td><td>'+v.g_intro+'</td><td><a href="">查看详情</a></td></tr>';
    //         })
            
    //          $('.app').siblings('.act').remove();
    //          $('.app').after(str1);
    //     }) 
    // })
  })
