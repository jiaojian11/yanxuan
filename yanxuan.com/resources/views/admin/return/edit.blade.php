    ...
    <div class="panel-body"> 
       <div class="row"> 
        <div class="col-lg-6 col-lg-offset-3"> 
         ...
         <form role="form" method="post" action="{{url('/admin/return/update')}}" enctype="multipart/form-data"> 
          <div class="form-group"> 
           <label>退货ID</label> 
           <input class="form-control" name="r_reson" value="{{$return->r_id}}" type="text"  disabled="true"/> 
           <!-- <textarea class="form-control" name="s_description" disabled="true" rows="8">{{$return->r_id}}</textarea> -->
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>用户ID</label> 
           <input class="form-control" name="r_reson" value="{{$return->u_id}}" type="text"  disabled="true"/> 
           <!-- <textarea class="form-control" name="s_description" disabled="true" rows="8">{{$return->u_id}}</textarea> -->
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>订单编号</label> 
           <input class="form-control" name="r_reson" value="{{$return->od_id}}" type="text"  disabled="true"/> 
           <!-- <textarea class="form-control" name="s_description" disabled="true" rows="8">{{$return->od_id}}</textarea> -->
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>原因</label> 
           <!-- <input class="form-control" name="r_reson" value="{{$return->r_reson}}" type="text"  disabled="true"/>  -->
           <textarea class="form-control" name="s_description" disabled="true" rows="8">{{$return->r_reson}}</textarea>
           <p class="help-block"></p> 
          </div> 
           <div class="form-group"> 
           <label>产品信息</label> 
           <!-- <input class="form-control" name="r_description" value="{{$return->r_description}}" type="text"  disabled="true"/>  -->
           <textarea class="form-control" name="s_description" disabled="true" rows="8">{{$return->r_description}}</textarea>
           <p class="help-block"></p> 
          </div> 
           <div class="form-group"> 
           <label>订单状态</label> 
          <!-- <input class="form-control" name="r_state" value="{{$return->r_state}}" type="text" />  -->
         <select name="r_state" value="{{$return->r_state}}" aria-controls="dataTables-example" class="form-control input-sm"><option value="已处理">已处理</option><option value="订单信息异常">订单信息异常</option><option value="退货理由不成立">退货理由不成立</option>
          <option value="暂不处理" onclick="createInput()">暂不处理</option>
        </select>
           <p class="help-block"></p> 
          </div> 
          <input type="hidden" name="r_id" value="{{$return->r_id}}">
