        ...
        <div class="box">
          ...
          <form action="/admin/banner/add" method="post" enctype="multipart/form-data">
            ...
            <tr>
                <th>一级分类</th>
                <td>
                  <select class="form-control fir" name="gc_id"> 
                    @foreach($res as $c=>$d)
                    <option value="{{$d->gc_id}}" selected>{{$d->gc_title}}</option>
                    @endforeach
                  </select>
                </td>
              </tr>
              <tr>
                <th>商品</th>
                <td>
                 <select class="form-control goods" name="g_id">
               ...
               <tr>
                ...
                <td>
                  <select class="form-control" name="ban_status">
                    <option value="1" selected>主页轮播</option>
                    <option value="2">列表轮播</option>
                  </select>
                </td>
              </tr>
               <tr>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td>{{$v->ban_id}}</td>
                  <td><img src="/adminCSS{{$v->ban_pic}}" style="width:50px" /></td>
                  <td>{{$v->gc_id}}</td>
                  @foreach($arr[$k] as $q=>$w)
                  <td>{{$w->g_name}}</td>
                  @endforeach
                  <td>
                    <a href="/admin/banner/edit?ban_id={{$v->ban_id}}">修改</a>|
                    <a href="/admin/banner/del?sid={{$v->ban_id}}">删除</a>
                  </td>
                </tr>
                @endif
                @endforeach
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td>{{$b->ban_id}}</td>
                  <td><img src="/adminCSS{{$b->ban_pic}}" style="width:50px" />
                  </td>
                  <td>{{$b->gc_id}}</td>
                  @foreach($arr[$a] as $q=>$w)
                  <td>{{$w->g_name}}</td>
                  @endforeach
                  <td>
                  <a href="/admin/banner/edit?ban_id={{$b->ban_id}}">修改</a>|
                  <a href="/admin/banner/del?sid={{$b->ban_id}}">删除</a>
                  </td>
                </tr>
                @endif
                @endforeach
...
<script>
  ...
  $(function(){
    $('.fir').change(function(){
        ...
        $.post('/admin/banner/change',{id:inp},function(data)
        {
            ...
            $.each(two,function(k,v){
              str+='<option value="'+v.g_id+'">'+v.g_name+'</option>';
            })
