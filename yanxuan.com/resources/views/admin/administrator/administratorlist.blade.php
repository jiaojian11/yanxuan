      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('/admin/administrator/index')}}"><i class="fa fa-circle-o"></i> 管理员列表</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/adminCSS/pages/charts/morris.html"><i class="fa fa-circle-o"></i>退货管理</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <div class="panel-body"> 
     <div class="dataTable_wrapper"> 
      <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
       <form action="/admin/administrator/index" method="get">
       <div class="row">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
         <div id="dataTables-example_filter" class="dataTables_filter">
          <label>管理员搜索:<input name="uname" class="form-control input-sm" placeholder="" aria-controls="dataTables-example" type="text" /></label>
       ...
       <div class="row">
        <div class="col-sm-12">
         <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info"> 
          <thead> 
           <tr role="row">
            <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 191px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">ID</th>
            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="Browser: activate to sort column ascending">管理员账户</th>
            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 200px;" aria-label="Platform(s): activate to sort column ascending">昵称</th>
            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 164px;" aria-label="Engine version: activate to sort column ascending">权限</th>
            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 119px;" aria-label="CSS grade: activate to sort column ascending">当前状态</th>
            ...
            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 119px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
           </tr> 
          </thead> 
          <tbody>
       @foreach($administrator as $k=>$v)
           <tr class="gradeA odd" role="row"> 
            <td class="sorting_1">{{$v->ad_id}}</td> 
            <td class="center">{{$v->ad_account}}</td> 
            <td>{{$v->ad_nick}}</td> 
            <td class="center">@if($v->ad_autho==1)超级管理员@else管理员@endif</td> 
            <td class="center">@if($v->ad_status==0)禁用@else可用@endif</td> 
            <td class="center" style="width:200px;">{{date('Y/m/d H:i:s',$v->ad_mktime)}}</td> 
            <!-- <td class="center" style="width:200px;">{{$v->ad_lastLogin}}</td>  -->
            <td class="center">
              <a href="/admin/administrator/disable?id={{$v->ad_id}}">
              <button type="button" class="btn btn-primary btn-xs">@if($v->ad_status==1)禁用@else解禁@endif</button>
              </a>
            </td> 
           </tr>
       @endforeach
       ...
       <div class="row">
        ...
        <div class="col-sm-6">
         {!! $administrator->appends($all)->render() !!}
        </div>
       </div>
      </div> 
     </div> 
