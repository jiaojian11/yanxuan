      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{url('/admin/administrator/add')}}"><i class="fa fa-circle-o"></i> 管理员添加</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <div class="panel-body"> 
       <div class="row"> 
        <div class="col-lg-6 col-lg-offset-3"> 
         <form role="form" method="post" action="{{url('admin/administrator/insert')}}" enctype="multipart/form-data"> 
          <div class="form-group"> 
           <label>管理员账户</label> 
           <input class="form-control" name="ad_account" value="{{old('ad_account')}}" type="text" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>密码</label> 
           <input class="form-control" name="ad_pass" value="{{old('ad_pass')}}" type="password" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>昵称</label> 
           <input class="form-control" name="ad_nick" value="{{old('ad_nick')}}" type="text" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>头像上传</label> 
