...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/dingdan/all"><i class="fa fa-circle-o"></i> 所有订单</a></li>
  ...
  <div class="content-wrapper">
    ...
    <form style="margin-top:29px;margin-left:20px" class="navbar-form navbar-left" role="search" action="/admin/dingdan/soul" method="post">

            <div class="form-group">
              <input name="did" type="text" class="form-control" placeholder="订单号">
            </div>
    ...
    <!-- /.content -->
    <!-- ============================================================================================= -->
    <div style="margin-left:40px ;margin-top:50px" class="box-body">
                <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered table-hover dataTable" id="example2" role="grid" aria-describedby="example2_info">
                  ...
                  <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">优惠券</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">订单状态</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">下单时间</th>
                    
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">支付方式</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">是否退货</th>
                  ...
                  <tr role="row" class="odd">
                    ...
                    @if($v->o_payMethod == 1)
                    <td>信用卡</td>
                    @elseif($v->o_payMethod == 2)
                    <td>储蓄卡</td>
                    @elseif($v->o_payMethod == 3)
                    <td>网易支付</td>
                    @elseif($v->o_payMethod == 4)
                    <td>微信支付</td>
                    @else
                    <td>支付宝</td>
                    @endif
                    ...
                    <td>正在退货</td>
                    @endif
                    <td><a href="/admin/dingdan/xiangqing?id={{$v->o_id}}">详情</a></td>
