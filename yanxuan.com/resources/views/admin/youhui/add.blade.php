...
<div class="wrapper">
  ...
  <form class="form-horizontal" action="/admin/youhui/adds" method="post">
  <div style="width:600px;margin-top:40px;margin-left:50px" class="box-body">
    <div  class="form-group">
      <label for="inputEmail3" class="col-sm-2 control-label">优 惠 券</label>

      <div class="col-sm-10">
        <input type="hidden" name="ctime" value="">
        <input type="hidden" name="atime" value="" >
        
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="text" name="c_name" class="form-control" id="inputEmail3" placeholder="优惠券名称">
      </div>
    </div>

  <div style="margin-left:3px" class="form-group">
    <label style="margin-left:14px"  for="inputEmail3" class="">优惠金额</label>
    <select style="margin-top:8px;margin-left:28px" name="jine" id="one">
      <option value="20">20 元</option>
      <option value="20">25 元</option>
      <option value="40">45 元</option>
      <option value="50">50 元</option>
      <option value="60">60 元</option>
      <option value="60">85 元</option>
      <option value="60">175 元</option>
    </select>
  </div>

    <div class="form-group">
      <label for="inputEmail3" class="col-sm-2 control-label">有效日期</label>

      <div class="col-sm-4" style="margin-top:8px">
        <li class="laydate-icon" id="start" style="width:200px;float: left;list-style:none;" ></li><br><br>
         <li class="laydate-icon" id="end" style="width:200px;float: left;margin-left: 0px;list-style:none;"></li><br><br>
      </div>
    </div>


    <div class="form-group">
      <label for="inputEmail3" class="col-sm-2 control-label">使用条件</label>

      <div class="col-sm-10">
        
        <input style="float:left;width:200px" type="text" name="c_claim" class="form-control" id="inputEmail3" placeholder="单笔订单满多少元可以优惠">　(元)
      </div>
    </div><br><br>

    <button style="width:150px;margin-left:100px" type="" class="btn btn-block btn-primary btn-lg">确定</button>
...
<script src="/adminCSS/laydate/laydate.js"></script>
  ...
  // alert($);
    var start = {
        ...
        choose: function(datas){
            ...
            // var ct = new Date().getTime(datas);
            
            $('input[name=ctime]').val(end.start);
            // console.log(ct);
    ...
    var end = {
        ...
        choose: function(datass){
            start.max = datass; //结束日选好后，重置开始日的最大日期
            // alert(datass);
           // var at = new Date().getTime(datass);  
            $('input[name=atime]').val(start.max);
            // console.log(at);
        }
    };
    ...
    $(function(){
      $('.btn-lg').click(function(){
        // alert(22);
        // alert($('#start').html());
        $('input[name=ctime]').val($('#start').html());
        $('input[name=atime]').val($('#end').html());
