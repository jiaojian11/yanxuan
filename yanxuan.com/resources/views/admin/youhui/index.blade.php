...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="#">
            ...
            <i class="fa fa-angle-left pull-right"></i>
            <ul class="treeview-menu">
              <li class="active"><a href="/admin/youhui/index"><i class="fa fa-circle-o"></i>优惠券</a></li>
            </ul>
          </a>
        </li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
    <!-- ================================================================================== -->
     <div style="width:200px;margin-top:50px;margin-left:40px">
    <a href="/admin/youhui/add"><button type="button" class="btn btn-block btn-primary btn-lg">创建商品优惠券</button></a>
    </div>

    <div style="margin-left:40px ;margin-top:20px" class="box-body">
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered table-hover dataTable" id="example2" role="grid" aria-describedby="example2_info">
          <thead>
          <tr role="row">
              <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">订单ID</th>
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">优惠券名称</th>
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">优惠金额</th>
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">有效日期</th>
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">使用条件</th>
              
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">发行时间</th>
              ...
              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">相关操作</th>
          </tr>
          </thead>
          <tbody>
          @foreach($res as $k=>$v)
          <tr role="row" class="odd">
            <td>{{$v->c_id}}</td>
            <td class="sorting_1">{{$v->c_name}}</td>
            <td>{{$v->c_money}}元</td>
            <td>{{date('Y-m-d H:i:s',$v->c_overTime)}}</td>
            <td>满{{$v->c_claim}}元</td>
            <td>{{date('Y-m-d H:i:s',$v->c_beginTime)}}</td>
            @if($v->c_status == 1)
            <td>可领取</td>
            @else
            <td>不可领取</td>
            @endif
            <td><a class="jiang" sid="{{$v->c_id}}" href="">结束领取</a></td>
          </tr>
          @endforeach
          </tbody>
          <tfoot>
        ...
        </table></div></div><div class="row"><div class="col-sm-5"><div class="dataTables_info" id="example2_info" role="status" aria-live="polite"></div></div><div class="col-sm-7">{!! $res->render() !!}</div></div></div>
      </div>
...
<script>
  $(function(){
    $('.jiang').click(function(){
      ...
      $.post('/admin/youhui/del',{id:sid},function(data){
          if(data){
            list.parent('td').prev().html('不可领取');
          }else{
            alert('修改失败');
          }
      })
