      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{url('/admin/user/integral')}}"><i class="fa fa-circle-o"></i> 积分管理</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
       ...
       <div class="panel-body"> 
        <div class="dataTable_wrapper"> 
         <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
          <form action="/admin/user/integral" method="get">
          <div class="row">
           <div class="col-sm-6">
            <div class="dataTables_length" id="dataTables-example_length">
             <label>显示 <select name="nums" aria-controls="dataTables-example" class="form-control input-sm">
                          <option value="3">3</option>
                          <option value="6">6</option>
                          <option value="9">9</option>
                          <option value="100">100</option></select> 页</label>
            </div>
           </div>
           <div class="col-sm-6">
            <div id="dataTables-example_filter" class="dataTables_filter">
             <label>用户名搜索:<input name="unames" class="form-control input-sm" placeholder="" aria-controls="dataTables-example" type="search" /></label>
          ...
          <div class="row">
           <div class="col-sm-12">
            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info"> 
             <thead> 
              <tr role="row">
               <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 160px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">ID</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="Browser: activate to sort column ascending">用户名</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="Platform(s): activate to sort column ascending">会员等级</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="Engine version: activate to sort column ascending">积分</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="CSS grade: activate to sort column ascending">优惠力度</th>
             ...
             @foreach($users as $k=>$v)
              <tr class="gradeA odd" role="row"> 
               ...
               <td>{{$v->u_account}}</td> 
               <td>
                 @if($v->u_integral==0)普通用户
                 @elseif($v->u_integral>0 && ($v->u_integral<10000))V1小白生活家
                 @elseif($v->u_integral>=10000 && ($v->u_integral<50000))V2智慧生活家
                 @elseif($v->u_integral>=50000 && ($v->u_integral<100000))V3品质生活家
                 @elseif($v->u_integral>=100000)V4至尊生活家
                 @endif
               </td> 
               <td class="center">{{$v->u_integral}}</td> 
               <td class="center">
                 @if($v->u_integral==0)0
                 @elseif($v->u_integral>0 && ($v->u_integral<10000))9.8折
                 @elseif($v->u_integral>=10000 && ($v->u_integral<50000))9.5折
                 @elseif($v->u_integral>=50000 && ($v->u_integral<100000))9.2折
                 @elseif($v->u_integral>=100000)9折
                 @endif
               </td>  
              </tr>
              @endforeach
