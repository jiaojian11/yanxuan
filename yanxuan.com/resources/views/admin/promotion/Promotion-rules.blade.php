  ...
  <div class="content-wrapper">
    ...
    <!-- =========================================================================================== -->
        ...
        <div class="col-md-10" style="margin-left: 30px;margin-top: 20px;">
         <form action="/admin/promotion/active" method="get">
             <div style="float: left;margin-top: 1px;">
                <input type="radio" name="check" checked>
             </div>
             <span style="float: left;">限时优惠</span><br><br>
             促销名称: <input type="text" name="name" maxlength="25">(25字以内)<br><br>
             <span style="float: left;">促销时间:</span>
             <li class="laydate-icon" id="start" style="width:200px;float: left;list-style:none;" ></li>
             <li class="laydate-icon" id="end" style="width:200px;float: left;margin-left: 20px;list-style:none;"></li><br><br>
             <input type="hidden" name="ctime" value="">
             <input type="hidden" name="atime" value="">
             优惠力度:在此价格基础上再减 <input type="text" name="youhui" style="width: 50px;" placeholder=" 10" > 元<br><br>
             <button>创建活动</button>
         </form>
        </div>
    </div>
