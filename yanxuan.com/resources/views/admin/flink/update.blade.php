    ...
    <div class="panel-body"> 
       <div class="row"> 
        <div class="col-lg-6 col-lg-offset-3"> 
         ...
         <form role="form" method="post" action="{{url('admin/flink/doupdate')}}" enctype="multipart/form-data"> 
          <div class="form-group"> 
           <label>链接名称</label> 
           <input class="form-control" name="fl_name" value="{{$data->fl_name}}" type="text" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>链接地址</label> 
           <input class="form-control" name="fl_link" value="{{$data->fl_link}}" type="text" /> 
           <input type="hidden" name="fl_id" value="{{$data->fl_id}}">
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label></label> 
           <img src="/adminCSS{{$data->fl_pic}}" alt="" width="100">
           <p class="help-block"></p> 
          </div>
          <div class="form-group"> 
           <label>链接图像上传</label> 
           <input name="fl_pic" type="file"/> 
          </div> 
          {{ csrf_field() }} 
