      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/flink/index"><i class="fa fa-circle-o"></i>友情链接管理</a></li>
            ...
            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info"> 
             <thead> 
              <tr role="row">
               ...
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 180px;" aria-label="Browser: activate to sort column ascending">链接名称</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 200px;" aria-label="Platform(s): activate to sort column ascending">链接图标</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">链接地址</th>
               <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 220px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
              </tr> 
             </thead> 
             <tbody> 
             @foreach($data as $k=>$v)
             <tr class="gradeA odd" role="row"> 
              <td class="sorting_1">{{$v->fl_id}}</td> 
              <td class="center">{{$v->fl_name}}</td> 
              <td><img src="/adminCSS/{{$v->fl_pic}}" alt="" width="30px"></td> 
              <td class="center">{{$v->fl_link}}</td> 
              <td class="center">
                <a href="/admin/flink/update?id={{$v->fl_id}}">
                <button type="button" class="btn btn-primary btn-xs">修改</button>
                </a>
                <a href="/admin/flink/delete?id={{$v->fl_id}}">
