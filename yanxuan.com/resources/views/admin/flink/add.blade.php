        ...
        <li class="treeview">
         ...
         <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/admin/flink/add"><i class="fa fa-circle-o"></i> 友情链接添加</a></li>
          </ul>
        </li>
      </ul>
    </section>
    ...
    <div class="panel-body"> 
       <div class="row"> 
        <div class="col-lg-6 col-lg-offset-3"> 
         ...
         <form role="form" method="post" action="{{url('admin/flink/insert')}}" enctype="multipart/form-data"> 
          <div class="form-group"> 
           <label>链接名称</label> 
           <input class="form-control" name="fl_name" value="{{old('fl_name')}}" type="text" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>链接地址</label> 
           <input class="form-control" name="fl_link" value="{{old('fl_link')}}" type="text" /> 
           <p class="help-block"></p> 
          </div> 
          <div class="form-group"> 
           <label>链接图像上传</label> 
